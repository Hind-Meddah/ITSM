            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Moniteur</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('main-content')
    ...
    <div class="row">
        <!-- /.modal -->
        <!-- /.modal -->
        <div class="modal fade" id="modal-DetailMoniteur">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td id="moniteur-id" class="bg-light"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Établissement </strong></td>
                                                        <td id="moniteur-Establishment" class="bg-light"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Salle</strong></td>
                                                        <td id="moniteur-Class" class="bg-light"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Label</strong></td>
                                                        <td id="moniteur-Label" class="bg-light"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Serial Number</strong></td>
                                                        <td id="moniteur-Serial" class="bg-light"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>État</strong></td>
                                                        <td id="moniteur-Status" class="bg-light"></td>
                                                    </tr>

                                                    <tr>
                                                        <td><strong>Inventory Number</strong></td>
                                                        <td id="moniteur-Inventory" class="bg-light"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Marque</strong></td>
                                                        <td id="moniteur-Manufacturer" class="bg-light"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Model</strong></td>
                                                        <td id="moniteur-Model" class="bg-light"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Parent UC</strong></td>
                                                        <td id="moniteur-Parent" class="bg-light"></td>
                                                    </tr>
        ...
        <div class="modal fade" id="modal-DeleteMoniteur">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Suprrimer Moniteur</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <p>Voulez vous vraiment supprimé cet moniteur ?</p>
        ...
        <div class="modal fade" id="modal-ModifyMoniteur">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-light">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>ID</label>
                                        <input type="text" class="form-control" name="id_moniteur_modif"
                                            id="id_moniteur_modif" readonly />
        ...
        <!-- /.modal -->
        <div class="modal fade" id="modal-AddMoniteur">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-light">
                        <h5 class="modal-title">
                    ...
                    <form action="" method="post" id="frm_addMoniteur">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="classeSelect" name="classeSelect">
                                            <option value="" selected disabled>Selectioner classe</option>
                                        </select>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="parentUc" id="parentUc">
                                            ...
                                            {{-- @foreach ($ordinateursParents as $ordinateurParent)
                                                <option value="{{ $ordinateurParent->id }}">{{ $ordinateurParent->label }}</option>
                                            @endforeach --}}
                                        </select>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            <option selected disabled>Choissez le État</option>
                                            <option value="0">Active</option>
                                            <option value="1">En panne</option>
                                        </select>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="model_select" name="model_select">
                                            <option selected disabled>Choissez le Modèle</option>
                                        </select>
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Moniteurs liste</h3>
                </div>

                <div class="card-body">
                    @if (Auth::check() && Auth::user()->Role != 'USER')
                        <button type="button" class="btn btn-success mb-3" data-toggle="modal"
                            data-target="#modal-AddMoniteur">
                            Ajouter Moniteur
                        </button>
                    @endif
                    <table class="table table-bordered table-hover" id="MoniteurTable">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Libellé</th>
                        ...
                        <tbody class="text-center py-0 align-middle">
                            ...
                            @foreach ($moniteurs as $moniteur)
                                <tr>
                                    <td>{{ $moniteur->id }}</td>
                                    <td>{{ $moniteur->label }}</td>
                                    <td>{{ $moniteur->marque->name }}</td>
                                    <td>{{ $moniteur->classe->establishement->name }}</td>
                                    <td>{{ $moniteur->classe->name }}</td>
                                    @if (@isset($moniteur->device->label))
                                        <td>{{ $moniteur->device->label }}</td>
                                    @else
                                        <td> - </td>
                                    @endif
                                    <td> <span
                                            class="badge {{ $moniteur->status === 1 ? 'badge-danger' : 'badge-success' }}">
                                            {{ $moniteur->status === 1 ? 'En panne' : 'Active' }}
                                        </span></td>
                                    {{-- @if (Auth::check() && Auth::user()->Role != 'USER') --}}
...
@section('moniteur_script')
    ...
    <script>
        $(document).ready(function() {
            var MoniteurTable = $('#MoniteurTable').DataTable({
                "paging": true,
                "lengthChange": false,
                "searching": true,
                "ordering": true,
                ...
                "columnDefs": [{
                    ...
                    },
                    {
                        ...
                        "defaultContent": "<div class=\"btn-group btn-group-sm\">" +
                            "<?php if ($A): ?>" +
                            "<a href=\"#\" class=\"btn btn-info\" data-toggle=\"modal\" data-target=\"#modal-ModifyMoniteur\" id=\"modifiymoniteurbtn\"><i class=\"fas fa-edit\"></i></a>" +
                            "<a href=\"#\" class=\"btn btn-danger\" data-toggle=\"modal\" data-target=\"#modal-DeleteMoniteur\" id=\"deletemoniteurbtn\"><i class=\"fas fa-trash\"></i></a>" +
                            "<?php endif; ?>" +
                            "<a href=\"#\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#modal-DetailMoniteur\" id=\"Viewmoniteurbtn\"><i class=\"fas fa-eye\"></i></a>" +
                            "</div>"
                    }
            ...
            // ajax add
            $("#frm_addMoniteur").submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#modal-AddMoniteur').modal('hide');

                        Toast.fire({
                            icon: 'success',
                            title: "Le moniteur a bien été ajouté"
                        });
                        $("#frm_addMoniteur")[0].reset();
            ...
            // AJAX MODIFY 
            $(document).on('click', '#modifiymoniteurbtn', function() {
                const row = $(this).closest('tr');
                const rowData = MoniteurTable.row(row).data();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        console.log(response);
                        $("#id_moniteur_modif").val(response.Moniteur.id);
                        // $("#parentUc_modier").val(response.Moniteur.parent_ref);
                        $("#libelleInput_modif").val(response.Moniteur.label);
                        $("#num_serie_modif").val(response.Moniteur.n_série);
                        $("#num_inventaire_modif").val(response.Moniteur.n_inventaire);
                        $("#marque_id_modif").val(response.Moniteur.marque.id);
                        $("#status_modif").val(response.Moniteur.status);
                        $("#etabliSelect_modif").val(response.Moniteur.classe
                            .establishement_id);
                        // Clear and populate the 'classeSelect_modif' dropdown
                        $("#classeSelect_modif").empty();
                        response.Moniteur.classe.establishement.classes.forEach((classObj) => {
                            $("#classeSelect_modif").append(new Option(classObj.name,
                                classObj.id));
                        });
                        $("#classeSelect_modif").val(response.Moniteur.classe_id);
                        ...
                        $("#model_select_modif").val(response.Moniteur.model_id);
                    },
                    error: function(xhr, status, error) {
                ...
                $("#modifyfrm").one('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            MoniteurTable.row(row).data(MoniteurData).draw(false);
                            $('#modal-ModifyMoniteur').modal('hide');
                            Toast.fire({
                                icon: 'success',
                        ...
                        error: function(xhr, status, error) {
                            ...
                            Toast.fire({
                                icon: 'error',
                                title: "Le moniteur N'a pas  ajouter"
                            });
            ...
            // ajax delete 
            $(document).on('click', '#deletemoniteurbtn', function() {
                const row = $(this).closest('tr');
                const rowData = MoniteurTable.row(row).data();
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.code === "200") {
                                ...
                                MoniteurTable.row(row).remove().draw(false);
                                $('#modal-DeleteMoniteur').modal('hide');
                                var Toast = Swal.mixin({
                                    toast: true,
                                    position: 'top-end',
                                    showConfirmButton: false,
            ...
            // ajax details
            $(document).on('click', '#Viewmoniteurbtn', function() {
                const row = $(this).closest('tr');
                const rowData = MoniteurTable.row(row).data();
                console.log(rowData[0]);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        document.getElementById("moniteur-id").textContent = response.id;

                        // Set the value of the "Establishment" cell
                        document.getElementById("moniteur-Establishment").textContent = response
                            .classe.establishement.name;

                        // Set the value of the "Class" cell
                        document.getElementById("moniteur-Class").textContent = response.classe
                            .name;

                        // Set the value of the "Label" cell
                        document.getElementById("moniteur-Label").textContent = response.label;

                        // Set the value of the "Serial Number" cell
                        document.getElementById("moniteur-Serial").textContent = response
                            .n_série;

                        // Set the value of the "Status" cell
                        const statusCell = document.getElementById("moniteur-Status");
                        ...
                        document.getElementById("moniteur-Inventory").textContent = response
                            .n_inventaire;

                        // Set the value of the "Marque" cell
                        document.getElementById("moniteur-Manufacturer").textContent = response
                            .marque.name;

                        // Set the value of the "Model" cell
                        document.getElementById("moniteur-Model").textContent = response.model
                            .name;
                        document.getElementById("moniteur-Parent").textContent = response.device
                            .label;
