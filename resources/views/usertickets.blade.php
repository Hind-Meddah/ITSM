...
@section('main-content')
    ...
    <section class="content">
        <div class="row">
                            ...
                            <div class="card card-outline card-light">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table-responsive mb15">
                                                <table class="table" id="tabledetailEnattent">
                                                    <thead>
                                                        <tr>
                                                            <th>Property</th>
                                                            <th>Value</th>
            ...
            {{-- modal delete en attent ticket --}}
            <div class="modal fade" id="modal-DeleteTicket">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Suprrimer Ticket</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <p>Voulez vous vraiment supprimé cet Ticket ?</p>

                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button>
                            <button type="button" class="btn btn-danger" id="btncnfdeleteuc">Confirmer la
                                suppression</button>
                        </div>
            ...
            {{--  Confirmer ticket accepted --}}

            <div class="modal fade" id="modal-confirmerTicket">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Voulez vous vraiment Confirmer que votre Ticket est Terminer ?</p>

                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button>
                            <button type="button" class="btn btn-success" id="btnconfirmerTicket">Confirmer </button>
                        </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td id="description-Tech-details-terminer" class="bg-light"></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Date Acceptation</strong></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td id="terminer-Ticket-details-terminer" class="bg-light"></td>
                                                        </tr>
                        ...
                        <ul class="nav custom-nav-pills flex-column">
                            <li class="nav-item">
                                <a class="nav-link " id="vert-tabs-home-tab" data-toggle="pill" href="#vert-tabs-home"
                                    role="tab" aria-controls="vert-tabs-home" aria-selected="true"><i
                                        ...
                                        id="spanEnattent">{{ $nbrticketstatus0 }}</span></a>
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" id="vert-tabs-profile-tab" data-toggle="pill"
                                    ...
                                    aria-selected="false"><i class="fas fa-check-circle  text-success"></i> Acceptée <span
                                        class="badge bg-success float-right"
                                        id="spanAccepted">{{ $nbrticketstatus1 }}</span></a>
        ...
        $(document).ready(function() {
            ...
            var attentTable = $('#En_attent_table').DataTable({
                ...
                "columnDefs": [{
                    "targets": -1,
                    "data": null,
                    "defaultContent": '<div class="btn-group btn-group-sm"><a href="#" class="btn btn-danger" data-toggle="modal" data-target="#modal-DeleteTicket" id="deleteTicketbtn"><i class="fas fa-trash"></i></a><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal-attentTicket" id="attentTicket"><i class="fas fa-eye" title="Details" aria-label="Details"></i></a></div>'
                }],
            ...
            var AcceptedTable = $('#Accepted_table').DataTable({
                ...
                "columnDefs": [{
                    "targets": -1,
                    "data": null,
                    "defaultContent": '<div class="btn-group btn-group-sm"><a href="#" class="btn btn-success" data-toggle="modal" data-target="#modal-confirmerTicket" id="confirmerTicket"><i class="fas fa-check" title="Confirmer" aria-label="Confirmer"></i></a><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal-acceptedTicket" id="acceptedTicket"><i class="fas fa-eye" title="Details" aria-label="Details"></i></div>'
                }],
            ...
            var TerminerTable = $('#Terminer_table').DataTable({
                ...
                "columnDefs": [{
                    "targets": -1, // Actions
                    "data": null,
                    "defaultContent": '<div class="btn-group btn-group-sm"><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal-terminerTicketdetails" id="terminerTicketdetails"><i class="fas fa-eye" title="Details" aria-label="Details"></i></a></div>'
                }],
            ...
            $(document).on('click', '#deleteTicketbtn', function() {
                ...
                $('#btncnfdeleteuc').one('click',function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            document.getElementById("spanEnattent").textContent =
                                parseInt(document.getElementById("spanEnattent")
                                    .textContent) - 1;
                            attentTable.row(row).remove().draw(false);
                            $('#modal-DeleteTicket').modal('hide');

                            Toast.fire({
                                icon: 'success',
                                title: "Ticket supprimé avec success"
                            });
            ...
            // confirmer le ticket accipted
            // confirmer le ticket accipted
            $(document).on('click', '#confirmerTicket', function() {
                const row = $(this).closest('tr');
                const rowData = AcceptedTable.row(row).data();
                console.log(rowData[0]);
                $('#btnconfirmerTicket').one('click',function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            document.getElementById("spanAccepted").textContent =
                                parseInt(document.getElementById("spanAccepted")
                                    .textContent) - 1;
                            document.getElementById("spanConfirmed").textContent =
                                parseInt(document.getElementById("spanConfirmed")
                                    .textContent) + 1;
                            AcceptedTable.row(row).remove().draw(false);

                            // Define etatColor and etat variables
                            const etatColor = 'info';
                            const etat = 'Confirmée';



                            // Add new row to confirmedTable
                            confirmedTable.row.add([
                                rowData[0],
                                rowData[1],
                                rowData[2],
                                rowData[3],
                            ...
                            $('#modal-confirmerTicket').modal('hide');

                            Toast.fire({
                                icon: 'success',
                                title: "Ticket Confirmer avec success"
                            });
            ...
            // // details terminer
            $(document).on('click', '#terminerTicketdetails', function() {
                const row = $(this).closest('tr');
